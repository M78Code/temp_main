...
import '../gameplay_des/gameplay_des_dialog.dart';
...
class BetOnController extends GetxController {
  ...
  /// 切换游戏玩法
  RxInt mBetPlayType = BetPlayType.CLASSICS.value.obs;

  /// 超和是否打开
  RxBool isSuperTieOpenObs = false.obs;

  /// 是否开牌
  RxBool isOpenPoker = false.obs;
  ...
  updateGameStatusModel(int protocolId, dynamic model) {
    ...
    switch (protocolId) {
      ...
      case 107: //监听服务器主动推送107（结算 ）-结算中
        var ws107model = model as Ws107Model;
