...
import 'package:flutter_main/models/user_info_model.dart';
...
class GlobalController extends GetxController {
  ...
  /// 用户 金额
  /// etc
  Rx<UserInfoModel> mUserInfoModel = UserInfoModel().obs;
  ...
  void loginSuccess(AppConfigModel appConfigModel) {
    ...
    mUserInfoModel.value.playerId = appConfigModel.playerId;
