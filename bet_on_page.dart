...
import 'package:flutter_main/pages/play/bet_commission_switch/bet_game_commission_switch_page.dart';
...
import 'package:flutter_main/pages/play/peeking_poker/peeking_poker_page.dart';
import 'package:flutter_main/pages/play/poker/open_poker_page.dart';
...
class BetOnPage extends GetView<BetOnController> {
        ...
        children: [
          Column(
            children: [
              ...
              //投注-小玩法
              ChipFlyPage(
                chlid: PlayBetOnWidget(
                    key: ChipFlyController.controller.globalKey),
              ),
              confirmArea2PlayArea2OpenPoker(context),
              //路纸图
              PlayRoadTabWidget(),
            ],
          ),
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Spacer(),
            HYContainer(
              backgroundImage: R.playIconPlayWarm,
              width: 12,
              height: 12,
              ...
              child: GestureDetector(
                onTap: (() {
                  ...
                  showModalBottomSheet(
                    ...
                    // backgroundColor: AppColors.lightBackgroundColor04,
                    useRootNavigator: true,
                    builder: (final context) => BetGameCommissionSwitchPage(),
                  );
                }),
                child: Text("CB".tr,
  ...
  /// 开牌
  openPoker() {
    return GetBuilder<BetOnController>(
      id: "openPoker",
      builder: (logic) {
  ...
  /// 咪牌
  peekingPoker() {
    // return const PeekingPokerPage();
    return FadeTransition(
      opacity: controller.fadeAnimation,
      child: SlideTransition(
        position: controller.slideAnimation,
        child: const PeekingPokerPage(),
      ),
    );
  }
