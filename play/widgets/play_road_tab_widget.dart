...
class PlayRoadTabWidget extends GetView<BetOnController> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          /// 庄问路 按钮
          buildGameRoadToolBarBtn("庄",Image.asset("assets/images/road/light/ic_zhuang_ask.png"), onTap: () {}),

          /// 闲问路 按钮
          buildGameRoadToolBarBtn("闲",Image.asset("assets/images/road/light/ic_xian_ask.png"), onTap: () {}),
  ...
  Widget buildGameRoadToolBarBtn(String title, Image betImage,{required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        // padding: EdgeInsets.fromLTRB(0, 5, 0, 0),
        decoration: BoxDecoration(
          color: AppColors.darkLineColor01,
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              title,
              style: TextStyle(fontSize: 14, color: AppColors.lightCommonColor01),
            ),
