              ...
              children: [
                Row(
                  ...
                  children: [
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_ZERO.value,
                      betOnController: controller,
                    ),
                    _SuperTieItemWidget(
                    ...
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_THREE.value,
                      betOnController: controller,
                    ),
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_FOUR.value,
                      betOnController: controller,
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_FIVE.value,
                      betOnController: controller,
                    ),
                    _SuperTieItemWidget(
                    ...
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_SEVEN.value,
                      betOnController: controller,
                    ),
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_EIGHT.value,
                      betOnController: controller,
                    ),
                    _SuperTieItemWidget(
                      betPointId:
                          BaccaratBetPointGroupType.SUPER_TIE_NINE.value,
                      betOnController: controller,
                    ),
                  ],
                ),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
                ...
                right: 8.w,
                child: GestureDetector(
                  onTap: () => betOnController.onTapBetHelp(betPointId),
                  child: Container(
                    width: 10.w,
                    height: 10.w,
                    alignment: Alignment.center,
