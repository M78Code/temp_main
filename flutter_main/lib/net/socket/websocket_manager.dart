...
class WebSocketManager {
  ...
  static Future sendMessageSocket(
    ...
    processData['clientDeviceType'] = GlobalController.controller.clientDeviceType;
    processData['deviceType'] =
        GlobalController.controller.deviceType;
    ...
    var request = SocketRequest(
        ...
        ServiceTypeId.getServiceTypeValue(serviceType),
        currentTimeMillis,
        processData,
        jsonDataText,
