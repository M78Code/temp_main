...
class Ws10053TableModelEvent {

  final Ws10053TableModel mainModel;

  Ws10053TableModelEvent(this.mainModel);

}

class Ws10053GameTableMapModelEvent {

  /// ⚠️注： 这里有多少个key 列表里有多少个桌子！！（itemCount）
  late Map<String, dynamic> mainMap;

  Ws10053GameTableMapModelEvent(this.mainMap);

}


Ws10053TableModel ws10053TableModelFromJson(String str) => Ws10053TableModel.fromJson(json.decode(str));

String ws10053TableModelToJson(Ws10053TableModel data) => json.encode(data.toJson());

/// 每个桌子的内容 用这个解析
class Ws10053TableModel {
  int? tableId;
  int? gameCasinoId;
  ...
  factory Ws10053TableModel.fromJson(Map<String, dynamic> json) => Ws10053TableModel(
...
class BetPointLimit {
  ...
  factory BetPointLimit.fromJson(Map<String, dynamic> json) => BetPointLimit(
    ...
    dynamicBetPoint: json["dynamicBetPoint"] == null ? [] : List<DynamicBetPoint>.from(json["dynamicBetPoint"]!.map((x) => DynamicBetPoint.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "dynamicBetPoint": dynamicBetPoint == null ? [] : List<dynamic>.from(dynamicBetPoint!.map((x) => x.toJson())),
  };
}
...
class DynamicBetPoint {
  ...
  factory DynamicBetPoint.fromJson(Map<String, dynamic> json) => DynamicBetPoint(
    name: json["name"],
    rate: json["rate"],
  );
