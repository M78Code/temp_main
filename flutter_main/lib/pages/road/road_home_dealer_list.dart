...
/// 首页-好路-荷官模式列表
class RoadHomeDealerList extends StatefulWidget {
  const RoadHomeDealerList({super.key});

  @override
  State<RoadHomeDealerList> createState() => _RoadHomeDealerListState();
}

class _RoadHomeDealerListState extends State<RoadHomeDealerList> {
  // 获取全局控制器实例
